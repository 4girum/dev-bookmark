...
export default function LandingPage() {
  return (
    <main className="min-h-screen flex flex-col bg-white dark:bg-[#0a0a0a]">
      {/* Navbar */}
      <header className="w-full border-b border-neutral-200 dark:border-neutral-800">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3">
          {/* Logo / wordmark */}
          <span className="text-sm font-semibold tracking-tight text-neutral-900 dark:text-neutral-100">
            DevBookmark <span className="text-indigo-500">Hub</span>
          </span>
      ...
      {/* Hero — centred in remaining viewport height */}
        ...
        <div className="max-w-2xl w-full text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50 leading-tight">
            ...
            <span className="text-indigo-500 dark:text-indigo-400">
              Your Developer{" "}
              <span className="bg-linear-to-r from-indigo-500 to-violet-500 bg-clip-text font-extrabold text-transparent">
                Knowledge Hub
              </span>
            </span>
          </h1>
